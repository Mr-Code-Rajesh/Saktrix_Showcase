...
export default function GlitchNavbar() {
  ...
  return (
    <motion.nav
      ...
      className="sticky top-0 z-50 w-full backdrop-blur-lg bg-black/40 dark:bg-gray-900/40 border-b border-pink-400 shadow-lg"
        ...
        <div className="hidden md:flex gap-8">
          {links.map(link => (
            <motion.a
              ...
              className="flex items-center gap-2 px-3 py-1 rounded-lg font-semibold text-pink-400 dark:text-purple-300 hover:bg-pink-100/20 dark:hover:bg-purple-900/20 transition duration-300 border-b-2 border-transparent glitch-link"
            >
        ...
        <div className="flex flex-col gap-4 py-4 px-6">
          {links.map(link => (
            <motion.a
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-lg font-semibold text-pink-400 dark:text-purple-300 hover:bg-pink-100/20 dark:hover:bg-purple-900/20 transition duration-300 border-b-2 border-transparent glitch-link"
            >
              {link.icon} <span className="glitch-text">{link.name}</span>
            </motion.a>
          ))}
